...
\begin{frame}
	...
	\begin{center}
	\begin{figure}
  		\includegraphics[width=\linewidth]{./img/JDBC/apis.jpg}
...
\begin{frame}
	...
	\begin{center}
	\begin{figure}
  		\includegraphics[width=\linewidth]{./img/JDBC/apisJDBC.jpg}
...
\begin{frame}
	...
	\begin{center}
	\begin{figure}
  		\includegraphics[width=0.35\linewidth]{./img/JDBC/Connection.jpg}
...
\begin{frame}
	...
	\begin{center}
	\begin{figure}
  		\includegraphics[width=0.9\linewidth]{./img/JDBC/mapings}
...
\frametitle{Entwurfsmuster}
	\begin{block}{Definition Entwurfsmuster}
		In der objektorientierten Softwareentwicklung sind \textbf{Entwurfstmuster Klassen in Rollen,} die zusammenarbeiten, um \textbf{gemeinsam} eine \textbf{bestimmte Aufgabe} zu \textbf{lÃ¶sen}.\cite{architektur}	\end{block}
\end{frame}
...
\begin{alertblock}{Problem}
	Es soll eine Klasse geben, von der sichergestellt werden muss, dass nur eine einzige Instanz von ihr existiert. FÃ¼r das Erzeugen der einzigen Instanz soll die genannte Klasse selbst verantwortlich sein. \cite{architektur}
\end{alertblock}
\end{frame}
...
\begin{center}
	\begin{figure}
  		\includegraphics[width=0.9\linewidth]{./img/JDBC/uml}
...
\begin{frame}
	...
	\framesubtitle{}
	\inputminted{java}{./src/JDBC/Singleton.java}	
	\end{frame}
